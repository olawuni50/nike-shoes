        ...
        <footer className="max-container">
            ...
            max-lg:flex-col">
                <div className="flex flex-col items-start">
                    ...
                    sm:max-w-sm">Get shoes ready for the new term at your nearest Nike store. Find
                            ...
                            <div>
                                ...
                                <ul>
                                    {section.links.map((link) =>(
                                        <li className="mt-3 text-white-400 font-monstserrat text-base leading-normal
            ...
            <div className="flex justify.between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                    <Image src={copyrightSign} alt="copy right sign" width={20} height={20} className="rounded-full m-0" />
                        <p>Copyright. All rights researved.</p>
                    </div>
